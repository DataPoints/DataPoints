class DatasetFactory
  ...
  def firstDataset(id)
    ...
    Column.create(header_id: "#{new_header.dataset_id}", label: 'Typ_platitela', type_id: '1',datatyp: 'string')

    Summary.create( dataset_id:"#{dataset.id}", header:"Vyska_pohladavky", min:10.38, max:41926.7, mean:2223.1154, median:715.28 )
